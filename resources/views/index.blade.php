    ...
    <main class="main-content">
        ...
        @if (isset($user))
            ...
            <div class='edit-profile'>
                ...
                <form class='form' id='form' method='POST' enctype='multipart/form-data' action="{{ route('user.store') }}">
                    {{ csrf_field() }}
                    ...
                    <ul class="form__list">
                        ...
                        <li class="form__item">
                            <div class="form__title">Я согласен получать email-рассылку: {{ $user->newsletter_agree === '1' ? "согласен" : "не согласен"}}</div>
                        </li>
                    </ul>
                </form>
            </div>
                ...
                <form class='form' id='form' method='POST' enctype='multipart/form-data' action="{{ route('user.store') }}">
                    ...
                    <ul class="form__list">
                        ...
                        <li class="form__item">
                            ...
                            <input class='form__inline-input' id='image' type="file" value='image/jpeg,image/png' name='image'>
                        </li>
                        <li class="form__item">
                            <label class='form__label' for="phone">Телефон:</label>
                        ...
                        <li class="form__item">
                            <label class='form__inline-label' for="newsletter_agree">Я согласен получать email-рассылку</label>
                            <input class='form__inline-input' id='newsletter_agree' type="hidden" name='newsletter_agree' value="0" checked>
                            <input class='form__inline-input' id='newsletter_agree' type="checkbox" name='newsletter_agree' value="1">
                        </li>
                        <li class="form__item">
